...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-green-50">
      ...
      {/* Navbar */}
      <nav className="flex items-center justify-between px-6 py-4 bg-white/80 backdrop-blur-sm border-b border-gray-100 sticky top-0 z-40">
        <div className="flex items-center gap-2">
          <span className="text-2xl">🏛️</span>
          <span className="font-bold text-gray-800 text-lg">Scheme-AI</span>
        </div>
        ...
        >
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <button
              ...
              className="px-8 py-3 border-2 border-orange-400 text-orange-600 rounded-full font-semibold text-lg hover:bg-orange-50 transition-all"
            >
              🎙️ Voice Mode
            </button>
          </div>
      ...
      <section className="px-6 py-16 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-gray-500 mb-10 text-lg">{t(lang, 'languageSubtitle')}</p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {LANGUAGES.map((l, i) => (
              ...
              >
                ...
                <span className={`font-semibold text-sm ${lang === l.code ? 'text-orange-700' : 'text-gray-700'}`}>
                  {l.label}
                </span>
                {lang === l.code && (
      ...
      <section className="px-6 py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-12">{t(lang, 'featuresTitle')}</h2>
